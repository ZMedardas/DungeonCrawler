package
{
	...
	public class razor extends MovieClip
	{
		var hp:int=new int;
		...
		public function razor(X:int,Y:int,level_num:int):void
		{
			posX=X;
			posY=Y;
			...
			sprite.x-=25;
			sprite.y-=25;
			sprite.bitmapData.copyPixels(new razor_sp,sp_rect,sp_p,null,null,true);
		}
