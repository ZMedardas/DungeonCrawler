package
{
	...
	public class scelet_sword extends MovieClip
	{
		var hp:int=new int;
		...
		public function scelet_sword(X:int,Y:int,level_num:int):void
		{
			posX=X;
			posY=Y;
			...
			sprite.x-=25;
			sprite.y-=25;
			sprite.bitmapData.copyPixels(new scelet_sword_sp,sp_rect,sp_p,null,null,true);
		}
