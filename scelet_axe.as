package
{
	...
	public class scelet_axe extends MovieClip
	{
		var hp:int=new int;
		...
		public function scelet_axe(X:int,Y:int,level_num:int):void
		{
			posX=X;
			posY=Y;
			...
			sprite.x-=25;
			sprite.y-=25;
			sprite.bitmapData.copyPixels(new scelet_axe_sp,sp_rect,sp_p,null,null,true);
		}
